...
namespace SistemaCadastro
{
    public partial class Form1 : MetroFramework.Forms.MetroForm
    {
        ...
        public Form1()
        {
            ...
            comboEC.Items.Add("Nada a declarar");
        ...
        private void Listar()//limpar a lista
        {
            lista.Items.Clear();
        ...
        {
            CadastrarRanking k = new CadastrarRanking(txtTitulo.Text, txtData.Text);
            this.Hide();
            k.ShowDialog();
        }
    }
